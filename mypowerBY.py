...
def load_country_data(country):
    ...
    return df, df_buysell, padded_filenames, padded_values
...
def update_stock_chart(selected_rows, country):
    ...
    if selected_rows:
        ...
        try:
            ...
            volume_val, beta_val = get_gauge_values(ticker, country, df)
...
def populate_filename(click_data, country):
    ...
    _, _, padded_filenames, _ = load_country_data(country)
...
def update_homepage(country, n_clicks_list, click_data, stored_sector):
    ...
    df, _, _, padded_values = load_country_data(country)
